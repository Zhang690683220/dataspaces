...
private:
    ...
    std::chrono::high_resolution_clock::duration _total;

    double _to_millis(std::chrono::high_resolution_clock::duration duration) const
    {
...
public:
    Timer()
        : _is_running(false),
          _total(std::chrono::high_resolution_clock::duration::zero())
    {
    }
